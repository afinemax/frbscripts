...
if __name__ == "__main__":
    ...
    parser.add_argument("-s", "--sigma", help="Sigma (default 15.0)", default=15.0, type=float)
    ...
    for singlepulsefile in tqdm(args.singlepulsefiles):
        ...
        make_candidates_for_singlepulsefile(filterbankfile, singlepulsefile, args.sigma, args.time)
